...
$title = 'Tambah Supplier | Market PPLG';
            ...
            <div class="row">
              ...
              <div class="col-lg-8 mb-3">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="telpon" id="telpon" class="form-control" placeholder="nomor telpon supplier" pattern="[0-9]{5,}" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <textarea name="alamat" id="alamat" rows="1" class="form-control" placeholder="Alamat supplier" required></textarea>
                </div>
              </div>
            </div>
          </div>
